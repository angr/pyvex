...
std::string PyIRRegArray::__str__() const {
...
bool PyIRRegArray::__eq__(const VEXObject& other) const {
...
size_t PyIRRegArray::__hash__() const {
...
std::string PyIRCallee::__str__() const {
    return name;
}

bool PyIRCallee::__eq__(const VEXObject& other) const {
...
size_t PyIRCallee::__hash__() const {
    return std::hash<int>{}(regparms) ^ 
            std::hash<std::string>{}(name) ^ 
            std::hash<int>{}(mcx_mask);
}

std::shared_ptr<PyIRCallee> PyIRCallee::_from_c(const IRCallee* c_callee) {
...
IRCallee* PyIRCallee::_to_c(const PyIRCallee& callee) {
